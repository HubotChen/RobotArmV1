...
static const _TargetPosition_type_support_symbol_names_t _TargetPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_messages, msg, TargetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_messages, msg, TargetPosition)),
  }
};
...
{
  return &::robot_messages::msg::rosidl_typesupport_cpp::TargetPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_messages, msg, TargetPosition)() {
  return get_message_type_support_handle<robot_messages::msg::TargetPosition>();
}
