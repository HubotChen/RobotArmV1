...
static const _TargetPosition_type_support_symbol_names_t _TargetPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_messages, msg, TargetPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_messages, msg, TargetPosition)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_messages, msg, TargetPosition)() {
  return &::robot_messages::msg::rosidl_typesupport_c::TargetPosition_message_type_support_handle;
}
