...
bool robot_messages__msg__targetposition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_messages.msg._targetposition.Targetposition", full_classname_dest, 49) == 0);
  }
...
PyObject * robot_messages__msg__targetposition__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_messages.msg._targetposition");
