...
#include "robot_messages/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const robot_messages::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_messages::msg::Num *>(
    untyped_ros_message);
...
{
  return &robot_messages::msg::typesupport_fastrtps_cpp::_Num__handle;
}
